...
AGENTS = [
    {
        ...
        "hashrate_base": 800,
        "hashrate_var": 50,
        "geo": {"lat": 37.7749, "lng": -122.4194}, # San Francisco (Tech Hub)
        "color": "#FF0000"
    },
    {
        "id": "DeepSeek-V3",
        ...
        "hashrate_base": 450,
        "hashrate_var": 20,
        "geo": {"lat": 35.6895, "lng": 139.6917}, # Tokyo (Precision)
        "color": "#00FFFF"
    },
    {
        "id": "Nexus-Mind",
        ...
        "hashrate_base": 300,
        "hashrate_var": 30,
        "geo": {"lat": 51.5074, "lng": -0.1278}, # London (Network Hub)
        "color": "#00FF00"
    }
]
        ...
        try:
            ...
            payload = {
                ...
                "payload": {
                    ...
                    "geo": {"lat": lat, "lng": lng},
                    "visuals": {
                        "threat_level": random.randint(0, 100) if agent['id'] == "Chaos-GPT" else random.randint(0, 20),
